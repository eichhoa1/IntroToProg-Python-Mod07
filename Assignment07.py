...
#   Adam Eichholz, 8/26/2025, Finished Script
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    ...
    Changelog:
        - Adam Eichholz, 8/26/2025: Created the class.
    """
    ...
    def first_name(self, value: str):
        if value.isalpha() or value == "":
            ...
            raise ValueError("The student's first name should not contain numbers.")
    ...
    def last_name(self, value: str):
        if value.isalpha() or value == "":
            ...
            raise ValueError("The student's last name should not contain numbers.")
...
class Student(Person):
    ...
    Properties:
        first_name (str): The student's first name.
        last_name (str): The student's last name.
        course_name (str): The name of the course the student is enrolling into.

    Changelog:
        Adam Eichholz, 8/26/2025: Created the class.
        Adam Eichholz, 8/26/2025: Added properties and private attributes.
        Adam Eichholz, 8/26/2025: Moved first_name and last_name into a parent class.
    """
